...
function getModel() {
    ...
    model = tf.sequential();
    // YOUR CODE HERE
    model.add(tf.layers.conv2d({inputShape: [28,28,1], kernelSize: 3, filters:50, activation: 'relu'}));
...
async function train(model, data) {
    ...
    const container ={ name: 'Model Training', style: {height: '1000px'} }; // YOUR CODE HERE    
